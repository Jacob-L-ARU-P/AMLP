...
store = file.Storage('K:\JL - 2213276\Y2-T2-W6-M\AMLP\TestBucket\GmailReadExample\storage.json') 
creds = store.get()
if not creds or creds.invalid:
    flow = client.flow_from_clientsecrets('K:\JL - 2213276\Y2-T2-W6-M\AMLP\TestBucket\GmailReadExample\credentials.json', SCOPES)
...
with open('K:\JL - 2213276\Y2-T2-W6-M\AMLP\TestBucket\GmailReadExample\CSV_NAME.csv', 'w', encoding='utf-8', newline = '') as csvfile: 
